...
public CommoditiesForm(UNFPAMIDlet midlet) {
    ...
    nb_male_condom = new TextField("La quantité", null, 6, TextField.NUMERIC);
    female_condom = new ChoiceGroup("Préservatif féminin", ChoiceGroup.POPUP, choice, null);
    nb_female_condom = new TextField("La quantité", null, 6, TextField.NUMERIC);
    oral_pills = new ChoiceGroup("de la pilule", ChoiceGroup.POPUP, choice, null);
    nb_oral_pills = new TextField("La quantité", null, 6, TextField.NUMERIC);
    injectable = new ChoiceGroup("Injectable", ChoiceGroup.POPUP, choice, null);
    nb_injectable = new TextField("La quantité", null, 6, TextField.NUMERIC);
    iud = new ChoiceGroup("DIU", ChoiceGroup.POPUP, choice, null);
    nb_iud = new TextField("La quantité", null, 6, TextField.NUMERIC);
    implants = new ChoiceGroup("des implants", ChoiceGroup.POPUP, choice, null);
    nb_implants = new TextField("La quantité", null, 6, TextField.NUMERIC);
